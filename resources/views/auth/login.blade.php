...
<body class="bg-white text-gray-800 overflow-hidden">
    ...
    <!-- Main Content -->
    <section class="h-[calc(100vh-64px)] bg-cover bg-center"
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <label for="remember_me" class="ml-2 block text-sm font-medium text-gray-700">Remember
                                me</label>
                        </div>
                        <a href="{{ route('password.request') }}"
                            class="text-sm font-medium text-gray-700 hover:text-red-500">Forgot password</a>
                    </div>
                    ...
                    <div class="text-sm text-center">
                        ...
                        <a href="{{ route('register') }}" class="text-red-600 font-semibold hover:text-red-500"> Sign
                            up</a>
                    </div>
                </form>
            </div>
