            ...
            <button class="relative cursor-pointer" dusk="notifications-button"
                ...
                @if ($unreadCount > 0)
                    <span id="unread-badge"
                        class="absolute -top-2 -right-2 accent-bg text-white text-xs font-bold px-1.5 py-0.5 rounded-full">
                        {{ $unreadCount }}
                    </span>
                @endif
            </button>
            ...
            <div x-data="notificationPanel()">
                ...
                <div class="space-y-4">
                    <template x-for="notification in unreadNotifications" :key="notification.id">
                        <div :dusk="'notification-' + notification.id" x-data="{ offset: 0, start: 0 }"
