...
@section('content')
    ...
    <div class="w-full max-w-xs md:max-w-7xl p-5 bg-white rounded-lg my-4 text-center shadow-md mx-auto animate-fade-in" x-data>
    ...
    @push('scripts')
        ...
        function closeModal() {
            document.getElementById('addAdminModle').classList.add('hidden');
        }
        </script>
