    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Review member health data for nutritional planning and dietary guidance.</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <form method="GET" class="flex flex-wrap gap-4 items-end">
            ...
            <div class="min-w-48">
                ...
                <select name="dietary_filter" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-red-500 focus:border-red-500">
                    <option value="">All Members</option>
                    <option value="restrictions" {{ request('dietary_filter') === 'restrictions' ? 'selected' : '' }}>Has Dietary Restrictions</option>
                    <option value="allergies" {{ request('dietary_filter') === 'allergies' ? 'selected' : '' }}>Has Allergies</option>
                    <option value="medical" {{ request('dietary_filter') === 'medical' ? 'selected' : '' }}>Medical Conditions</option>
                </select>
            </div>
