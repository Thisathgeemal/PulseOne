...
<div class="p-6 max-w-4xl mx-auto">
    ...
    <div class="grid md:grid-cols-4 gap-4 mb-6">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold">
                        ...
                        @if($assessment->bmi_category)
                            <span class="text-sm text-gray-500">({{ $assessment->bmi_category }})</span>
                        @endif
                    </p>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-4">
            <div class="flex items-center">
                <i class="fas fa-running text-orange-500 text-xl mr-3"></i>
                <div>
                    <p class="text-sm text-gray-600">Activity Level</p>
                    <p class="text-lg font-semibold">{{ ucfirst(str_replace('_', ' ', $assessment->activity_level)) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold">{{ ucfirst($assessment->exercise_experience) }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <p class="text-gray-900">{{ $assessment->height_cm }} cm</p>
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Weight</label>
                <p class="text-gray-900">{{ $assessment->weight_kg }} kg</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        ...
        @else
            <p class="text-gray-500">No specific goals specified</p>
        @endif
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">
            <i class="fas fa-apple-alt text-yellow-500 mr-2"></i>
            Dietary Information
        </h3>
        <div class="grid md:grid-cols-2 gap-6">
            <div>
                ...
                @else
                    <p class="text-gray-500">No dietary restrictions</p>
                @endif
            </div>
            <div>
                ...
                @else
                    <p class="text-gray-500">No known allergies</p>
                @endif
            </div>
        </div>
    </div>
