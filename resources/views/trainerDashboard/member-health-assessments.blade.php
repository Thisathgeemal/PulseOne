        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mt-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Review member health data for creating personalized workout plans and
                        training guidance.</p>
                </div>
            ...
            <form method="GET" class="flex flex-wrap gap-4 items-end">
                ...
                <div class="min-w-48">
                    ...
                    <select name="experience"
                        ...
                        <option value="beginner" {{ request('experience') === 'beginner' ? 'selected' : '' }}>Beginner
                        </option>
                        <option value="intermediate" {{ request('experience') === 'intermediate' ? 'selected' : '' }}>
                            Intermediate</option>
                        <option value="advanced" {{ request('experience') === 'advanced' ? 'selected' : '' }}>Advanced
                        </option>
                    </select>
                </div>
