...
@section('content')
    ...
    <div class="max-w-xl mx-auto px-6 py-10 bg-white rounded-xl shadow-lg animate-fade-in mt-6" x-data>
    ...
    <form action="{{ route('checkin-token') }}" method="POST" class="space-y-6" id="qrCheckinForm">
            ...
            <div>
                ...
                <input type="text" id="qr_code" name="qr_code"
                    ...
                    placeholder="Enter or scan QR code..." value="{{ $checkinToken }}" required>
            </div>
            ...
            <button type="submit"
                class="w-full bg-red-500 hover:bg-red-600 text-white font-semibold px-6 py-2 rounded-lg shadow-md">
