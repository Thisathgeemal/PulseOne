...
class AdminProfileTest extends DuskTestCase
{
    ...
    public function test_admin_can_update_profile_image()
    {
        $this->browse(function (Browser $browser) {
            $browser->visit('/login')
                ->type('email', 'admin@test.com')
            ...
            $user = User::find($this->admin->id)->fresh();
    ...
    public function test_admin_can_toggle_mfa()
    {
        $this->browse(function (Browser $browser) {
            $browser->visit('/login')
                ->type('email', 'admin@test.com')
            ...
            $this->admin->refresh();
            $this->assertTrue($this->admin->mfa_enabled);
        });
    }

    public function test_admin_can_logout_specific_device()
    {
        $this->browse(function (Browser $browser) {
    ...
    public function test_admin_can_logout_all_other_devices()
    {
        $this->browse(function (Browser $browser) {
